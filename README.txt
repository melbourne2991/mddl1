...
This document describes how to copy and customise the custom1 (bootstrapbase) theme so that
...
From your Moodle theme directory right click on custom1 and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of custom1.
...
underscores. For the purpose of this tutorial we will call the theme 'custom1theme'.

On opening 'custom1theme' your you will find several files and sub-directories which have
files within them.
...
where the old theme name occurs, in this case custom1. So using the above list as
a guide, search through and change all the instances of the theme name
'custom1' to 'custom1theme'. This includes the filename of the lang/en/theme_custom1.php.
You need to change this to 'theme_custom1theme.php'.
...
and then click on (custom1theme) or whatever you renamed your theme to,
from the list of theme names that appear at this point in the side block.

Customisation using custom theme settings
-----------------------------------------

The settings page for the custom1 theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > custom1

Moodle documentation
--------------------

Further information can be found on Moodle Docs: http://docs.moodle.org/dev/custom1_theme
